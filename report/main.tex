...
\begin{tabular}{ll}
\textbf{THESIS COMMITTEE:} & HCMUT Computer Science Council \\
\textbf{SUPERVISOR:} & Assoc. Prof. Trương Tuấn Anh, PhD \\ 
                     & B.Eng. Dương Huỳnh Anh Đức \\
...
The group hereby certifies that this specialized project is the result of our own research and work, conducted under the supervision of Dr. Truong Tuan Anh and Mr. Duong Huynh Anh Đuc. All research content and results presented in this project are truthful, objective, and have not been previously submitted to any educational institution for the purpose of obtaining an academic degree. All referenced materials are fully and properly cited, including the authors’ names, titles of the works, dates, and places of publication. \\
The group also certifies compliance with all regulations regarding the protection of intellectual property rights. Should any violations be discovered, the group accepts full responsibility before the Faculty Board and the Board of Rectors of Ho Chi Minh City University of Technology for the content of this declaration.
...
\end{center}
During our study and research at Ho Chi Minh City University of Technology, Vietnam National University Ho Chi Minh City, we received valuable guidance and support from the faculty members. This specialized project reflects our efforts to apply the knowledge acquired to practical problems in the field of information technology. \\
We would like to express our sincere gratitude to Dr. Truong Tuan Anh for his dedicated supervision, insightful guidance, and constructive feedback throughout the project. We also thank Mr. Duong Huynh Anh Đuc for his support and valuable practical contributions. \\
Our appreciation is extended to all lecturers of the Faculty of Computer Science and Engineering for their instruction and knowledge shared during our academic journey. We are also grateful to our families and friends for their encouragement and support. \\
Despite our best efforts, this project may contain certain limitations. We sincerely welcome constructive comments and suggestions for further improvement.
\newpage
