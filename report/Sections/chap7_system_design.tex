...
\begin{figure}[h]
    ...
    \begin{minipage}{0.23\textwidth}
        \centering
        \includegraphics[width=\linewidth]{Images/User Interface/onboard1.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.23\textwidth}
        \centering
...
%         \label{fig:qr-scan}
%     \end{subfigure}
%     \caption{User adding methods in the chat application}
%     \label{fig:add-user-methods}
% \end{figure}
