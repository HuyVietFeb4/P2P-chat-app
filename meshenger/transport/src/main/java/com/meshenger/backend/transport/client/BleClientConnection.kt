    ...
    override fun getGattCallback(): BleManagerGattCallback {
        return object : BleManagerGattCallback() {
            override fun isRequiredServiceSupported(gatt: BluetoothGatt): Boolean {
                ...
                Log.d("BleClientConnection", "Service Discovery: NotifyChar is ${if (notifyChar != null) "FOUND" else "MISSING"}")
            ...
            override fun initialize() {
                    ...
                    .with { device, data ->
                        ...
                        if (bytes != null) {
                            ...
                            try {
                                ...
                                Log.d("BleClientConnection", e.message ?: "Failed to setup callback")
                            }
                ...
                enableNotifications(notifyChar)
                    .done { Log.d("BleClientConnection", "Notifications Enabled") }
                    .fail { _, status -> Log.e("BleClientConnection", "Notify Failed: $status") }
                    .enqueue()
            }
